...
Name:          sb2-obs-diagnostics-i486-inject
Version:       1.0
Release:       1
AutoReqProv:   0
...
%package -n sb2-obs-diagnostics-i486-dependency-inject
Summary: Dependency for sb2 host side

%description -n sb2-obs-diagnostics-i486-dependency-inject
...
%files -n sb2-obs-diagnostics-i486-dependency-inject
%defattr(-,root,root)
